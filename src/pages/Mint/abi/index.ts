...
import LegendFactoryV2ABI from './LegendFactoryV2.json';
import PartnerTicketABI from './PartnerTicket.json';
import PartnerTicketFactoryABI from './PartnerTicketFactory.json';
import PartnerTicketRealTimeFactoryABI from './PartnerTicketRealTimeFactory.json';
